...
@click.argument('statistics_type', metavar='<statistics_type>', required=True, type=click.Choice(['twoway-delay', 'twoway-loss']))
@click.argument('session_name', metavar='<session_name>', required=False)
@click.option('--brief', '-b', is_flag=True, help="Enable brief output")
@click.option('--lastest_number', '-l', is_flag=False, type=click.INT, help="Enable lastest number set of statistics output")
@click.option('--verbose', is_flag=True, help="Enable verbose output")
@clicommon.pass_db
